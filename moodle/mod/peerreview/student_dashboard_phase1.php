...
$PAGE->set_url('/mod/peerreview/student_dashboard_phase1.php', array('id' => $id));
...
$columns = [
    ...
    'completed_question' => get_string('completed_question', 'mod_peerreview'),
...
foreach ($students as $student) {
    $completed_questions_count = $DB->count_records('pr_question', array('userid' => $student->userid, 'sessionid' => $session->id, 'status' => 1));
