...
foreach ($students as $student) {
    ...
    $prods = $DB->get_records('pr_question', ['userid' => $student->userid]);
    ...
    foreach ($prods as $prod) {
        ...
        $answers = $DB->get_records('pr_answer', ['question_id' => $prod->id]);
    ...
    $eval_prod1 = $DB->get_records('pr_assignedqcm', ['prod1_id' => $student->userid]);
    $eval_prod2 = $DB->get_records('pr_assignedqcm', ['prod2_id' => $student->userid]);
    $eval_prod3 = $DB->get_records('pr_assignedqcm', ['prod3_id' => $student->userid]);
