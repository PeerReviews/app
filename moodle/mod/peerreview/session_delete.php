...
$DB->delete_records('peerreview', array('id' => $session_id));

// Rediriger vers la liste des QCM avec un message de succès
redirect(new moodle_url('/mod/peerreview/admin_session_gestion.php', array('id' => $id)), get_string('qcm_deleted', 'mod_peerreview'), null, \core\output\notification::NOTIFY_SUCCESS);
