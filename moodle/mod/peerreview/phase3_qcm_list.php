...
$PAGE->set_url('/mod/peerreview/phase3_qcm_list.php', array('id' => $id));
...
echo "<div class='mx-auto'>";
    echo "<p class='font-bold text-center text-3xl text-gray-600'>" . get_string('value_list', 'mod_peerreview') . "</p>";
echo "</div>";
...
echo "<div class='flex mt-8 mx-4 justify-between border-b p-2'>";
    echo "<div class='flex text-center text-gray-500 items-end'>";
        echo "<p class='mr-4 text-4xl font-semibold'> " . count($tcss) . "/" . $peerreview->nbtcs . "</p>";
...
echo "<div class='flex mt-8 mx-4 justify-between border-b p-2'>";
    echo "<div class='flex text-center text-gray-500 items-end'>";
        echo "<p class='mr-4 text-4xl font-semibold'> " . $completed_pops . "/" . $peerreview->nbpop . "</p>";
