...
$existing_teacher = $DB->get_record('pr_teachers', ['userid' => $user->id, 'sessionid' => $session->id]);
...
try {
    $DB->insert_record('pr_teachers', $new_teacher);
...
redirect(new moodle_url('/mod/peerreview/admin_add_user.php', array('id' => $id)));
?>
