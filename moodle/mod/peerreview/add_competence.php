...
$competenceId = $DB->insert_record('pr_competency', $competence);
...
foreach ($subCompetences as $sub) {
    ...
    $subCompetenceId = $DB->insert_record('pr_subcompetency', $subCompetence);
    ...
    foreach ($sub['keywords'] as $keyword) {
        ...
        $DB->insert_record('pr_keyword', $keywordRecord);
    }
}
