...
$DB->update_record('pr_grid_eval', $record_qcu);
$DB->update_record('pr_grid_eval', $record_qcm);
$DB->update_record('pr_grid_eval', $record_tcs);

redirect(new moodle_url('/mod/peerreview/admin_grid_eval.php', ['id' => $id]));
?>