...
echo "<p class='font-bold text-center text-3xl text-gray-600'>" . get_string('create_question', 'mod_peerreview') . " " . $type . "</p>";
echo "</div>";
...
echo "<div class='mt-8'>";
    ...
    // Question
    echo "<div class='rounded-3xl bg-indigo-200 my-4 p-4'>";
    echo "<label for='question_1' class='block font-semibold text-gray-700 text-lg'>" . get_string('question', 'mod_peerreview') . " <span class='text-red-500'>*</span> :</label>";
    ...
    for ($i = 1; $i <= 5; $i++) {
        ...
        if ($type != "TCS") {
            ...
            echo "<label for='answer_1_{$i}' class='col-span-2 block font-semibold text-gray-700 text-lg'>" . get_string('answer', 'mod_peerreview') . " $i :</label>";
        ...
        if($type != "TCS") {
            ...
            echo "<div class='py-2 grid grid-cols-12 w-full'>";
            echo "<label for='explanation_1_{$i}' class='col-span-2 block font-semibold text-gray-700 text-lg'>" . get_string('explanation', 'mod_peerreview') . " $i :</label>";
            echo "<div class='col-span-10 w-full'>";
        ...
        echo "<div class='py-2 grid grid-cols-12 w-full'>";
        echo "<label for='correct_answer_1_{$i}' class='col-span-2 block font-semibold text-gray-700 text-lg'>" . get_string('correct_answer', 'mod_peerreview') . " ?</label>";
