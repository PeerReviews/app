...
$PAGE->set_url('/mod/peerreview/student_dashboard_phase3.php', array('id' => $id));
...
$columns = [
    ...
    'reviewed_question' => get_string('reviewed_question', 'mod_peerreview'),
...
foreach ($students as $student) {
    $reviewed_questions_count = $DB->count_records('pr_question', array('userid' => $student->userid, 'sessionid' => $session->id, 'is_improved' => 1));
