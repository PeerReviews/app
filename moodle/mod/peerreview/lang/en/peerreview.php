...
$string['phase_end'] = 'End';
$string['phase_ended'] = 'Finished';
...
// Capabilities
$string['peerreview:manage'] = 'Manage a session instance';
$string['peerreview:addinstance'] = 'Add a session instance';
$string['peerreview:view'] = 'View a session instance';
