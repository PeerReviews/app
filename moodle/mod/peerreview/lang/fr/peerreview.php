<?php
// Fichier lang/fr/peerreview.php
...
$string['phase_end'] = 'Fin';
$string['phase_ended'] = 'Terminé';
...
$string['peerreview:manage'] = 'Gérer une instance de session';
$string['peerreview:addinstance'] = 'Ajouter une instance de session';
$string['peerreview:view'] = 'Voir une instance de session';
