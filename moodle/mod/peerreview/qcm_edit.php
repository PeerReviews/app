...
// Formulaire
echo "<form method='post' action='qcm_edit_process.php?id={$id}&qcm_id={$qcm_id}&type={$type}&is_improved=0'>";
echo "<div class='mt-8'>";
    ...
    for ($index = 1; $index <= 5; $index++) {
        ...
        if($answer = current($answers)){
            ...
            echo "<label for='answer_1_{$index}' class='col-span-2 block font-semibold text-gray-700 text-lg'>" . get_string('answer', 'mod_peerreview') . " $index :</label>";
            ...
            if($type != "TCS") {
                ...
                // Explication
                echo "<div class='py-2 grid grid-cols-12 w-full'>";
                echo "<label for='explanation_1_{$index}' class='col-span-2 block font-semibold text-gray-700 text-lg'>" . get_string('explanation', 'mod_peerreview') . " $index :</label>";
                echo "<div class='col-span-10 w-full'>";
            ...
            echo "<div class='py-2 grid grid-cols-12 w-full'>";
            echo "<label for='correct_answer_1_{$index}' class='col-span-2 block font-semibold text-gray-700 text-lg'>" . get_string('correct_answer', 'mod_peerreview') . " ?</label>";
...
echo "<div class='mb-4 mt-4 flex justify-end space-x-2'>";
    echo "<button type='submit' name='save' class='inline-block px-4 py-2 font-semibold rounded-2xl bg-lime-200 hover:bg-lime-300 cursor-pointer text-lime-700 no-underline text-lg'>" .
        get_string('save', component: 'mod_peerreview') . "</button>";
    echo "<button type='submit' name='submit' class='inline-block px-4 py-2 font-semibold rounded-2xl bg-lime-200 hover:bg-lime-300 cursor-pointer text-lime-700 no-underline text-lg'>" . 
        get_string('submit', 'mod_peerreview') . "</button>";
echo "</div>";  
...
tinymce.init({
    ...
    setup: function (editor) {
      ...
      // Nettoyer les images dupliquées avant la sauvegarde
