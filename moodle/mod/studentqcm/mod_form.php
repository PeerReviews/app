...
class mod_studentqcm_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('html', '<h2 class="text-3xl font-bold">' . get_string('subcompetences_title', 'mod_studentqcm') . '</h2>');
        // Ajout du bouton "Ajouter sous-competences"
        $mform->addElement('html', '<h3 class="text-2xl font-bold">' . get_string('info_subcompetence', 'mod_studentqcm') . '</h3>');
        ...
        $mform->addElement('html', '<h2 class="text-3xl font-bold">' . get_string('keyword_title', 'mod_studentqcm') . '</h2>');
        // Ajout du bouton "Ajouter mot-clefs"
        $mform->addElement('html', '<h3 class="text-2xl font-bold">' . get_string('info_keyword', 'mod_studentqcm') . '</h3>');
