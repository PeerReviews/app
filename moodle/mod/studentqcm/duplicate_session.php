...
// $new_session->name = $session->name . ' (copie)';
// $new_session->timecreated = time(); // Date de création mise à jour
...
// $new_name = $max_number > 0 ? "$base_name " . ($max_number + 1) : $base_name;
