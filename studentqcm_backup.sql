...
INSERT INTO `mdl_studentqcm_question` VALUES (54,3,'q1','comment1','santé',1,1,2,0,'QCM',0,NULL,NULL,NULL),(55,4,'q2','comment2','santé',1,1,2,0,'QCM',0,NULL,NULL,NULL),(57,3,'Quel est le rôle principal de l\'artère coronaire ?','Question sur la physiologie cardiaque.','Système cardiovasculaire',1,1,2,0,'QCM',0,NULL,NULL,NULL),(58,3,'Quel est le rôle principal de l\'artère coronaire ?','Question sur la physiologie cardiaque.','Système cardiovasculaire',1,1,2,1,'QCM',0,NULL,NULL,NULL),(59,3,'Quel est le rôle principal du ventricule gauche du cœur ?','Question sur la physiologie cardiaque.','Système cardiovasculaire',1,1,2,1,'QCU',0,NULL,NULL,NULL),(61,3,'Quelles sont les étapes du traitement médicamenteux d\'une insuffisance cardiaque ?','Question sur le traitement des maladies cardiaques.','Système cardiovasculaire',1,1,2,1,'TCS',0,NULL,NULL,NULL),(77,2,'question pop',NULL,NULL,1,4,2,0,'QCU',1,16,NULL,NULL),(78,2,'question pop',NULL,NULL,1,4,2,0,'QCU',1,17,NULL,NULL),(79,2,'a',NULL,NULL,1,1,2,0,'QCU',1,18,NULL,NULL),(80,2,'aa',NULL,NULL,1,1,2,0,'QCU',1,19,NULL,NULL),(93,2,'test','','contexte',0,0,0,0,'QCM',0,NULL,NULL,NULL),(94,2,'Question',NULL,'',NULL,NULL,NULL,0,'QCM',0,NULL,NULL,NULL),(95,6,'Quelle est la principale cause des caries dentaires ?*','Les caries sont causées par la prolifération de bactéries qui attaquent l’émail des dents en présence de sucres.','Sant&eacute; bucco-dentaire',1,1,2,1,'QCM',0,NULL,NULL,3),(96,6,'Quel est l’organe le plus grand du corps humain ?','L’organe le plus grand du corps humain est essentiel à la protection et à la régulation thermique.  ','Anatomie humaine &nbsp;',1,6,2,1,'QCM',0,NULL,NULL,3),(97,6,'Quel nutriment est la principale source d’énergie pour le corps ?','L’énergie est indispensable pour le bon fonctionnement du corps humain, et elle provient principalement d’un type de nutriment.','Nutrition',1,4,2,1,'QCM',0,NULL,NULL,3),(98,6,'Quelle est la principale fonction des globules rouges ?','Les globules rouges jouent un rôle fondamental dans le transport d’un élément vital dans l’organisme.  ','Syst&egrave;me sanguin',1,4,2,1,'QCM',0,NULL,NULL,3),(99,6,'Quelle maladie est causée par une carence en fer ?','Un manque de fer peut entraîner une maladie affectant l’oxygénation du corps.','Maladies et nutrition',1,4,2,1,'QCM',0,NULL,NULL,3),(100,6,'Quelle est la principale cause du cancer du poumon ?','Le cancer du poumon est une des maladies les plus répandues et évitables grâce à la prévention.','Maladies et pr&eacute;vention&nbsp;',1,4,2,1,'QCU',0,NULL,NULL,3),(101,6,'Quelle est la principale source de vitamine C ?','La vitamine C est essentielle pour le système immunitaire et la santé de la peau. Elle se trouve principalement dans certains fruits et légumes.','Nutrition et vitamines',1,4,2,1,'QCU',0,NULL,NULL,3),(102,6,'Pourquoi est-il important de se laver les mains régulièrement ?','Se laver les mains réduit considérablement la propagation des maladies infectieuses et limite les contaminations croisées.','Hygi&egrave;ne et pr&eacute;vention',1,1,2,1,'QCU',0,NULL,NULL,3),(103,6,'Quel est l\'organe responsable de la production d\'insuline ?','L\'insuline est une hormone essentielle pour réguler le taux de sucre dans le sang.','Diab&egrave;te et m&eacute;tabolisme',1,1,2,1,'QCU',1,27,1,3),(104,6,'Quelle vitamine est principalement synthétisée grâce à l’exposition au soleil ?','Certaines vitamines sont produites naturellement par le corps humain sous certaines conditions.','Nutrition et sant&eacute;&nbsp;',1,4,2,1,'QCM',1,28,2,3),(105,6,'Quel est l’effet principal d’une consommation excessive de sel ?','Un excès de sel dans l’alimentation peut entraîner des conséquences graves sur la santé.','Nutrition et maladies',1,6,2,1,'QCM',1,29,3,3),(106,6,'Quel est l’effet principal d’une consommation excessive de sel ?','Un excès de sel dans l’alimentation peut entraîner des conséquences graves sur la santé. ','Nutrition et maladies',1,6,2,1,'QCM',1,30,3,3),(107,6,'Quelle est la meilleure méthode pour éviter les infections virales ?','Les virus se propagent facilement, mais certaines précautions peuvent réduire les risques.','Pr&eacute;vention et hygi&egrave;ne&nbsp;',1,4,2,1,'QCU',1,31,3,3),(108,6,'Quelle est la meilleure façon de réduire le risque d’ostéoporose ?','L’ostéoporose fragilise les os, augmentant le risque de fractures.','Sant&eacute; des os&nbsp;',1,1,2,1,'QCU',1,32,3,3),(109,6,'Quel est l’organe qui filtre les toxines du sang ?','Certains organes sont essentiels pour éliminer les substances nocives du corps.','Syst&egrave;me digestif et m&eacute;tabolisme',1,4,2,1,'QCM',1,33,4,3),(110,6,'Quelle est la maladie neurodégénérative la plus fréquente ?','Certaines maladies affectent progressivement les fonctions cérébrales avec l’âge.','Maladies et vieillissement',1,6,2,1,'QCU',1,34,4,3),(111,6,'Quel est le principal facteur de risque des maladies cardiovasculaires ?','Les maladies du cœur sont influencées par plusieurs facteurs, mais un en particulier est prédominant.','Sant&eacute; cardiovasculaire',1,6,2,1,'QCM',1,35,4,3),(112,6,'Quelle est la principale cause du diabète de type 2 ?','Le diabète de type 2 est une maladie influencée par le mode de vie.','Maladies m&eacute;taboliques&nbsp;',1,4,2,1,'QCU',1,36,4,3),(113,6,'Confiance en vos compétences en communication avec les patients','Cette question vise à évaluer la perception des étudiants en santé quant à leurs compétences en communication médicale. Un bon niveau de communication permet une meilleure adhésion des patients aux traitements et renforce la relation thérapeutique.','Dans le cadre de votre formation en sant&eacute;, vous &ecirc;tes amen&eacute;(e) &agrave; interagir avec des patients pr&eacute;sentant des pr&eacute;occupations vari&eacute;es. La communication est un &eacute;l&eacute;ment cl&eacute; pour &eacute;tablir une relation de confiance et garantir une prise en charge efficace.',1,4,2,1,'TCS',0,NULL,NULL,3),(114,6,'Dans quelle mesure vous sentez-vous capable de gérer efficacement votre stress en situation d’urgence médicale ?','Cette question permet d’évaluer la perception des étudiants quant à leur capacité à faire face au stress en situation critique. Une gestion efficace du stress est indispensable pour éviter les erreurs médicales et assurer une prise en charge optimale des patients.','Le domaine de la sant&eacute; expose r&eacute;guli&egrave;rement les professionnels &agrave; des situations stressantes, notamment lors d&rsquo;urgences vitales. La capacit&eacute; &agrave; g&eacute;rer son stress est essentielle pour prendre des d&eacute;cisions rapides et appropri&eacute;es.',1,4,2,1,'TCS',0,NULL,NULL,3);
...
-- Dump completed on 2025-02-26 10:11:35
